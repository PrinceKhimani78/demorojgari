...
const CandidateProfilePage = () => {
    ...
    return (
        <div className="pl-2 pr-4 sm:px-2 py-2 flex gap-3 sm:gap-4 my-30 relative min-h-screen bg-gray-50">
            <Sidebar type="recruiter" />
            
            <main className="flex-1 bg-white rounded-lg shadow-lg overflow-hidden flex flex-col">
                {/* Header Section */}
